  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <View style={{flex:0.03 ,backgroundColor:'#f7f6f6'}}></View>
        ...
        <View style={{flex:0.45,flexDirection:'column',position:'relative'}}>
          <View style={{flex:0.2 ,flexDirection:'row'}}>
            <View style={{flex:0.5}}>
              <TextInput style={{ fontSize:18,marginLeft:33}} placeholder='Nitesh' underlineColorAndroid = "transparent"/>
            </View>
            <View style={{flex:0.5}}>
              <TextInput style={{ fontSize:18,marginLeft:35}} placeholder='21' underlineColorAndroid = "transparent"/>
            </View>
          </View>
