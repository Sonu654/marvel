        ...
        <View style={{flex:0.59,flexDirection:'column'}}>
          ...
          <View style={{flex:0.3,flexDirection:'row'}}>
            <View style={{flex:0.3}}>
              ...
              <Icon name='arrow-left' style={{color:'white', fontSize:40,marginLeft:width*0.12,position:'absolute',marginTop:height*0.049}} onPress={()=>Actions.New_home_housemates()}/>
            </View>
            <View style={{flex:0.4}}></View>
            <View style={{flex:0.3}}>
              <Icon name='check-circle' style={{color:'#fbf1f1', fontSize:80,marginLeft:width*0.05,marginTop:height*0.02}} onPress={()=>Actions.Short_bio()}/>
            </View>
          </View>
        </View>
      </View>
