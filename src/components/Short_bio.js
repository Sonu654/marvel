      ...
      <View style={styles.container}>
        ...
        <View style={{flex:0.28 ,marginTop:20,flexDirection:'column'}}>
              <View style={{flex:0.13}}>
                  <Text style={{fontFamily:"Verdana",fontSize: 19,fontWeight:'bold',textAlign:'center', color:'rgb(68, 35, 124)'}}>Short bio</Text>
              </View>
              <View style={{flex:0.13}}>
                <Text style={{fontFamily:"Verdana",fontSize: 15.5,textAlign:'center', color:'gray',padding:7}}>Tell us about your home</Text>
              </View>
